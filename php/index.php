...
if ($_POST['METHOD'] == 'PUT') {
    ...
    $descripcionProducto = $_POST['descripcion_producto'];
    $cantidadProducto = $_POST['cantidad_producto'];
    $query = "UPDATE producto SET nombre_producto = '$nombreProducto', descripcion_producto = '$descripcionProducto', cantidad_producto = '$cantidadProducto' WHERE id_producto = '$id_Producto'";
